...
@class BDAutoTrackStatement;

/** Represents the results of executing a query on an `<BDAutoTrackDatabase>`.
...
@interface BDAutoTrackResultSet : NSObject {
    BDAutoTrackDatabase          *_parentDB;
    BDAutoTrackStatement         *_statement;
...
/** `BDAutoTrackStatement` used by result set. */

@property (atomic, retain) BDAutoTrackStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<BDAutoTrackStatement>`
 
 @param statement A `<BDAutoTrackStatement>` to be performed
 
 @param aDB A `<BDAutoTrackDatabase>` to be used
 
 @return A `BDAutoTrackResultSet` on success; `nil` on failure
 */
